...
<head>
    ...
    {{
      ...
      "@type": "BreadcrumbList",
      "itemListElement": [
        {{ "@type": "ListItem", "position": 1, "name": "Home", "item": "https://deepcaredentalclinic.co.ke/" }},
        {{ "@type": "ListItem", "position": 2, "name": "Services", "item": "https://deepcaredentalclinic.co.ke/services.html" }},
        {{ "@type": "ListItem", "position": 3, "name": "{name}", "item": "https://deepcaredentalclinic.co.ke/{slug}" }}
      ]
    }}
    </script>
    ...
    <meta name="robots" content="index, follow">
        <link rel="canonical" href="https://deepcaredentalclinic.co.ke/{slug}">
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://deepcaredentalclinic.co.ke/{slug}">
    ...
    <section class="service-detail-hero">
        <div class="container service-hero-grid">
             ...
             <div class="hero-image animate-on-scroll delay-100">
                  <!-- PERFORMANCE: Compress to WebP format before going live. Target: under 100KB for hero, under 40KB for card images -->
                  <img src="assets/images/service-{slug_img}.jpg" alt="{name} at Deep Care Dental Clinic" width="600" height="400" fetchpriority="high">
             </div>
        </div>
    </section>
    ...
    <div class="footer-col">
      ...
      <div class="social-icons">
        ...
        <a href="#" aria-label="Instagram">
          <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7.8 2h8.4C19.4 2 22 4.6 22 7.8v8.4a5.8 5.8 0 0 1-5.8 5.8H7.8C4.6 22 2 19.4 2 16.2V7.8A5.8 5.8 0 0 1 7.8 2zm-.2 2A3.6 3.6 0 0 0 4 7.6v8.8C4 18.39 5.61 20 7.6 20h8.8a3.6 3.6 0 0 0 3.6-3.6V7.6C20 5.61 18.39 4 16.4 4H7.6zm9.65 1.5a1.25 1.25 0 0 1 1.25 1.25A1.25 1.25 0 0 1 17.25 8 1.25 1.25 0 0 1 16 6.75a1.25 1.25 0 0 1 1.25-1.25zM12 7a5 5 0 0 1 5 5 5 5 0 0 1-5 5 5 5 0 0 1-5-5 5 5 0 0 1 5-5zm0 2a3 3 0 0 0-3 3 3 3 0 0 0 3 3 3 3 0 0 0 3-3 3 3 0 0 0-3-3z"/></svg>
        </a>
      </div>
    </div>
...
BENEFIT_SVG = '<svg class="benefit-icon-svg" aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>'
...
for service in services:
    ...
    page_content = header.format(
        ...
        desc=service["desc"],
        name=service["name"],
        icon=SVG_MAPPING[service["name"]].replace('<svg', '<svg aria-hidden="true"'),
        slug=slug,
        slug_img=slug_img,
